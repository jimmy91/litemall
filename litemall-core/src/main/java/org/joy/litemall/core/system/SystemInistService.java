package org.joy.litemall.core.system;

import org.joy.litemall.core.util.SystemInfoPrinter;
import org.joy.litemall.db.service.LitemallSystemConfigService;
...
class SystemInistService {
    ...
    private Map<String, String> getSystemInfo() {
        ...
        infos.put("调试级别", environment.getProperty("logging.level.org.joy.litemall.wx"));
