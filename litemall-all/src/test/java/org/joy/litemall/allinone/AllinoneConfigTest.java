package org.joy.litemall.allinone;
...
//        System.out.println(environment.getProperty(""));
        ...
        System.out.println(environment.getProperty("logging.level.org.joy.litemall.wx"));
        System.out.println(environment.getProperty("logging.level.org.joy.litemall.admin"));
        System.out.println(environment.getProperty("logging.level.org.joy.litemall"));
    }
