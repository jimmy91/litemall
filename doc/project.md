...
```
    ...
    <logger name="org.joy.litemall.core" level="DEBUG" />
    <logger name="org.joy.litemall.db" level="DEBUG" />
    <logger name="org.joy.litemall.admin" level="DEBUG" />
    <logger name="org.joy.litemall.wx" level="DEBUG" />
    <logger name="org.joy.litemall" level="DEBUG" />
```

具体如何配置，请自行学习Spring Boot的日志配置和logback日志配置。

`org.joy.litemall.core`定义litemall-core模块的日志级别
`org.joy.litemall.db`定义litemall-db模块的日志级别
`org.joy.litemall.wx`定义litemall-wx-api模块的日志级别
`org.joy.litemall.admin`定义litemall-admin-api模块的日志级别
`org.joy.litemall`而定义litemall所有后端模块的日志级别
